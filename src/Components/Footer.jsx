...
const Footer = () => {
  return (
    <div>
        <footer className='mt-20 border-t pt-10 border-neutral-700 pl-8 bg-cyan-600'>
        <div className='grid grid-cols-2 lg:grid-cols-3 gap-4'>
            ...
            <div>
              ...
              <ul className='space-y-2'>
                <li className='flex items-center text-gray-700 justify-center text-md md:text-lg'>
                    <MdOutlineMarkEmailRead className='text-2xl'/>
                    <p className='pl-2'>gkaquainoo@gmail.com</p>
                </li>
                <li className='flex items-center text-gray-700 justify-center text-md md:text-lg'>
            ...
            <div>
              <h3 className='text-md font-semibold mb-2 md:text-center text-xl text-white'>Social Media Handles</h3>
              <ul className='space-y-2 flex items-center md:justify-center'>
